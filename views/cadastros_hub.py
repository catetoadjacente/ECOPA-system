...
from utils.theme import font, ECOPA_GREEN, ECOPA_GREEN_LIGHT, ECOPA_GREEN_DARK, ECOPA_BG, ECOPA_WHITE, ECOPA_TEXT, ECOPA_TEXT_LIGHT, ECOPA_BORDER, ECOPA_BLUE
...
class CadastrosHub(ctk.CTkFrame):
    ...
    def abrir_cadastros(self):
        ...
        card_ponto.grid(row=1, column=0, padx=10, pady=10, sticky="nsew")
        ...
        card_dest.grid(row=1, column=1, padx=10, pady=10, sticky="nsew")
    ...
    def nova_destinacao(self):
        from views.cadastro_destinacao import CadastroDestinacao
        CadastroDestinacao(self, self.content, on_voltar=self.abrir_cadastros)
